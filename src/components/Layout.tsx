...
export function Layout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className={"app-shell " + (collapsed ? "sidebar-collapsed" : "")}>
      {mobileOpen && <button className="mobile-overlay" onClick={() => setMobileOpen(false)} aria-label="Cerrar menu" />}
      <aside className={"sidebar " + (mobileOpen ? "mobile-open" : "")}>
        <div className="brand">
          ...
          <button className="icon-button sidebar-mobile-close" onClick={() => setMobileOpen(false)} aria-label="Cerrar menu"><X size={19} /></button>
        </div>
        ...
        <div className="sidebar-footer">
          ...
          <button className="collapse-button" onClick={() => setCollapsed((current) => !current)} title={collapsed ? "Expandir menu" : "Contraer menu"}>
      ...
      <div className="main-area">
        <header className="topbar">
          ...
          <div className="account">
            ...
            <button className="icon-button" onClick={logout} aria-label="Cerrar sesion" title="Cerrar sesion"><LogOut size={18} /></button>
          </div>
        </header>
        <main
